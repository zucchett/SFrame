  ...
  for d in dataSets:
    ...
    for l in listOfJobs:
      ...
      if l[0]==d[0] and not l[4]=="" :
        ...
        if "Run2016" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("Run2016")[0]+fileBaseNameRoot.partition("Run2016")[1]+'*'
        elif "pythia8" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("pythia8")[0]+fileBaseNameRoot.partition("pythia8")[1]+'*'
        elif "madgraph" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("madgraph")[0]+fileBaseNameRoot.partition("madgraph")[1]+'*'
        elif "amcatnlo" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("amcatnlo")[0]+fileBaseNameRoot.partition("amcatnlo")[1]+'*'
        elif "powheg" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("powheg")[0]+fileBaseNameRoot.partition("powheg")[1]+'*'
    ...
    if checkReady:
      ...
      if "Run2016" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("Run2016")[0]+fileBaseNameRoot.partition("Run2016")[1]+fileBaseNameRoot.partition("Run2016")[2][0]+'*'
      elif "pythia8" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("pythia8")[0]+fileBaseNameRoot.partition("pythia8")[1]+'*'
      elif "madgraph" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("madgraph")[0]+fileBaseNameRoot.partition("madgraph")[1]+'*'
      elif "amcatnlo" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("amcatnlo")[0]+fileBaseNameRoot.partition("amcatnlo")[1]+'*'
      elif "powheg" in fileBaseNameRoot: fileToMerge=fileBaseNameRoot.partition("powheg")[0]+fileBaseNameRoot.partition("powheg")[1]+'*'
      else: fileToMerge=fileBaseNameRoot+'*'
      mergeCmd='hadd -f %s.root %s.root'  %(mergeFileBaseName,  fileToMerge)
      if not keepTemp: mergeCmd += ' && rm -rf %s.root'  % fileToMerge
...
def main():
  ...
  parser.add_option("-c", "--usecmssw", dest="cmssw",
                    action="store", default="CMSSW_7_4_7",
