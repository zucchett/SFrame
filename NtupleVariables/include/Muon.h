...
namespace UZH {
 ...
 , public Particle 
  ...
  public:
    ...
    int isTrackerHighPtMuon() const { /*if(!m_ana->getConnectSucceeded(Ntuple::MuonNtupleObject::kisTrackerHighPtMuon)) std::cout<<"isTrackerHighPtMuon not connected!"<<std::endl;*/ return *(m_isTrackerHighPtMuon); } 
    ...
    floatingnumber trackCorrIso() const { /*if(!m_ana->getConnectSucceeded(Ntuple::MuonNtupleObject::ktrackCorrIso)) std::cout<<"trackCorrIso not connected!"<<std::endl;*/ return *(m_trackCorrIso); } 
    ...
    floatingnumber innerTrack_pt() const { /*if(!m_ana->getConnectSucceeded(Ntuple::MuonNtupleObject::kinnerTrack_pt)) std::cout<<"innerTrack_pt not connected!"<<std::endl;*/ return *(m_innerTrack_pt); } 
    ...
    floatingnumber tunePTrack_pt() const { /*if(!m_ana->getConnectSucceeded(Ntuple::MuonNtupleObject::ktunePTrack_pt)) std::cout<<"tunePTrack_pt not connected!"<<std::endl;*/ return *(m_tunePTrack_pt); } 
    floatingnumber tunePTrack_ptErr() const { /*if(!m_ana->getConnectSucceeded(Ntuple::MuonNtupleObject::ktunePTrack_ptErr)) std::cout<<"tunePTrack_ptErr not connected!"<<std::endl;*/ return *(m_tunePTrack_ptErr); } 
    ...
    void isTrackerHighPtMuon( const int& val){ *(m_isTrackerHighPtMuon)=val; } 
    ...
    void trackCorrIso( const floatingnumber& val){ *(m_trackCorrIso)=val; } 
    ...
    void innerTrack_pt( const floatingnumber& val){ *(m_innerTrack_pt)=val; } 
    ...
    void tunePTrack_pt( const floatingnumber& val){ *(m_tunePTrack_pt)=val; } 
    void tunePTrack_ptErr( const floatingnumber& val){ *(m_tunePTrack_ptErr)=val; } 
