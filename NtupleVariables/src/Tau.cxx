...
if(  ((ana->detailLevel & Ntuple::TauAdvancedID) == Ntuple::TauAdvancedID)  ) {
    ...
    if (ana->m_connectsucceeded[14]) m_chargedIsoPtSumdR03 = &((*ana->chargedIsoPtSumdR03)[idx]); else m_chargedIsoPtSumdR03 = 0; 
    if (ana->m_connectsucceeded[15]) m_footprintCorrectiondR03 = &((*ana->footprintCorrectiondR03)[idx]); else m_footprintCorrectiondR03 = 0; 
    if (ana->m_connectsucceeded[16]) m_neutralIsoPtSumdR03 = &((*ana->neutralIsoPtSumdR03)[idx]); else m_neutralIsoPtSumdR03 = 0; 
    if (ana->m_connectsucceeded[17]) m_neutralIsoPtSumWeight = &((*ana->neutralIsoPtSumWeight)[idx]); else m_neutralIsoPtSumWeight = 0; 
    if (ana->m_connectsucceeded[18]) m_neutralIsoPtSumWeightdR03 = &((*ana->neutralIsoPtSumWeightdR03)[idx]); else m_neutralIsoPtSumWeightdR03 = 0; 
    if (ana->m_connectsucceeded[19]) m_photonPtSumOutsideSignalConedR03 = &((*ana->photonPtSumOutsideSignalConedR03)[idx]); else m_photonPtSumOutsideSignalConedR03 = 0; 
    if (ana->m_connectsucceeded[20]) m_byIsolationMVArun2v1DBdR03oldDMwLTraw = &((*ana->byIsolationMVArun2v1DBdR03oldDMwLTraw)[idx]); else m_byIsolationMVArun2v1DBdR03oldDMwLTraw = 0; 
    if (ana->m_connectsucceeded[21]) m_byIsolationMVArun2v1DBnewDMwLTraw = &((*ana->byIsolationMVArun2v1DBnewDMwLTraw)[idx]); else m_byIsolationMVArun2v1DBnewDMwLTraw = 0; 
    if (ana->m_connectsucceeded[22]) m_byIsolationMVArun2v1DBoldDMwLTraw = &((*ana->byIsolationMVArun2v1DBoldDMwLTraw)[idx]); else m_byIsolationMVArun2v1DBoldDMwLTraw = 0; 
    if (ana->m_connectsucceeded[23]) m_byIsolationMVArun2v1PWdR03oldDMwLTraw = &((*ana->byIsolationMVArun2v1PWdR03oldDMwLTraw)[idx]); else m_byIsolationMVArun2v1PWdR03oldDMwLTraw = 0; 
    ...
    if (ana->m_connectsucceeded[25]) m_byIsolationMVArun2v1PWoldDMwLTraw = &((*ana->byIsolationMVArun2v1PWoldDMwLTraw)[idx]); else m_byIsolationMVArun2v1PWoldDMwLTraw = 0; 
    ...
    if (ana->m_connectsucceeded[29]) m_byLooseIsolationMVArun2v1PWdR03oldDMwLT = &((*ana->byLooseIsolationMVArun2v1PWdR03oldDMwLT)[idx]); else m_byLooseIsolationMVArun2v1PWdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[30]) m_byLooseIsolationMVArun2v1PWnewDMwLT = &((*ana->byLooseIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byLooseIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[31]) m_byLooseIsolationMVArun2v1PWoldDMwLT = &((*ana->byLooseIsolationMVArun2v1PWoldDMwLT)[idx]); else m_byLooseIsolationMVArun2v1PWoldDMwLT = 0; 
    if (ana->m_connectsucceeded[32]) m_byMediumIsolationMVArun2v1DBdR03oldDMwLT = &((*ana->byMediumIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byMediumIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[33]) m_byMediumIsolationMVArun2v1DBnewDMwLT = &((*ana->byMediumIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byMediumIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[34]) m_byMediumIsolationMVArun2v1DBoldDMwLT = &((*ana->byMediumIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byMediumIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[35]) m_byMediumIsolationMVArun2v1PWdR03oldDMwLT = &((*ana->byMediumIsolationMVArun2v1PWdR03oldDMwLT)[idx]); else m_byMediumIsolationMVArun2v1PWdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[36]) m_byMediumIsolationMVArun2v1PWnewDMwLT = &((*ana->byMediumIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byMediumIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[37]) m_byMediumIsolationMVArun2v1PWoldDMwLT = &((*ana->byMediumIsolationMVArun2v1PWoldDMwLT)[idx]); else m_byMediumIsolationMVArun2v1PWoldDMwLT = 0; 
    ...
    if (ana->m_connectsucceeded[41]) m_byTightIsolationMVArun2v1PWdR03oldDMwLT = &((*ana->byTightIsolationMVArun2v1PWdR03oldDMwLT)[idx]); else m_byTightIsolationMVArun2v1PWdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[42]) m_byTightIsolationMVArun2v1PWnewDMwLT = &((*ana->byTightIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byTightIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[43]) m_byTightIsolationMVArun2v1PWoldDMwLT = &((*ana->byTightIsolationMVArun2v1PWoldDMwLT)[idx]); else m_byTightIsolationMVArun2v1PWoldDMwLT = 0; 
    if (ana->m_connectsucceeded[44]) m_byVLooseIsolationMVArun2v1DBdR03oldDMwLT = &((*ana->byVLooseIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[45]) m_byVLooseIsolationMVArun2v1DBnewDMwLT = &((*ana->byVLooseIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[46]) m_byVLooseIsolationMVArun2v1DBoldDMwLT = &((*ana->byVLooseIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[47]) m_byVLooseIsolationMVArun2v1PWdR03oldDMwLT = &((*ana->byVLooseIsolationMVArun2v1PWdR03oldDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1PWdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[48]) m_byVLooseIsolationMVArun2v1PWnewDMwLT = &((*ana->byVLooseIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[49]) m_byVLooseIsolationMVArun2v1PWoldDMwLT = &((*ana->byVLooseIsolationMVArun2v1PWoldDMwLT)[idx]); else m_byVLooseIsolationMVArun2v1PWoldDMwLT = 0; 
    if (ana->m_connectsucceeded[50]) m_byVTightIsolationMVArun2v1DBdR03oldDMwLT = &((*ana->byVTightIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byVTightIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[51]) m_byVTightIsolationMVArun2v1DBnewDMwLT = &((*ana->byVTightIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byVTightIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[52]) m_byVTightIsolationMVArun2v1DBoldDMwLT = &((*ana->byVTightIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byVTightIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[53]) m_byVTightIsolationMVArun2v1PWdR03oldDMwLT = &((*ana->byVTightIsolationMVArun2v1PWdR03oldDMwLT)[idx]); else m_byVTightIsolationMVArun2v1PWdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[54]) m_byVTightIsolationMVArun2v1PWnewDMwLT = &((*ana->byVTightIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byVTightIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[55]) m_byVTightIsolationMVArun2v1PWoldDMwLT = &((*ana->byVTightIsolationMVArun2v1PWoldDMwLT)[idx]); else m_byVTightIsolationMVArun2v1PWoldDMwLT = 0; 
    if (ana->m_connectsucceeded[56]) m_byVVTightIsolationMVArun2v1DBdR03oldDMwLT = &((*ana->byVVTightIsolationMVArun2v1DBdR03oldDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1DBdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[57]) m_byVVTightIsolationMVArun2v1DBnewDMwLT = &((*ana->byVVTightIsolationMVArun2v1DBnewDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1DBnewDMwLT = 0; 
    if (ana->m_connectsucceeded[58]) m_byVVTightIsolationMVArun2v1DBoldDMwLT = &((*ana->byVVTightIsolationMVArun2v1DBoldDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1DBoldDMwLT = 0; 
    if (ana->m_connectsucceeded[59]) m_byVVTightIsolationMVArun2v1PWdR03oldDMwLT = &((*ana->byVVTightIsolationMVArun2v1PWdR03oldDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1PWdR03oldDMwLT = 0; 
    if (ana->m_connectsucceeded[60]) m_byVVTightIsolationMVArun2v1PWnewDMwLT = &((*ana->byVVTightIsolationMVArun2v1PWnewDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1PWnewDMwLT = 0; 
    if (ana->m_connectsucceeded[61]) m_byVVTightIsolationMVArun2v1PWoldDMwLT = &((*ana->byVVTightIsolationMVArun2v1PWoldDMwLT)[idx]); else m_byVVTightIsolationMVArun2v1PWoldDMwLT = 0; 
    if (ana->m_connectsucceeded[62]) m_againstElectronMVA6raw = &((*ana->againstElectronMVA6raw)[idx]); else m_againstElectronMVA6raw = 0; 
    if (ana->m_connectsucceeded[63]) m_againstElectronMVA6category = &((*ana->againstElectronMVA6category)[idx]); else m_againstElectronMVA6category = 0; 
    if (ana->m_connectsucceeded[64]) m_againstElectronVLooseMVA6 = &((*ana->againstElectronVLooseMVA6)[idx]); else m_againstElectronVLooseMVA6 = 0; 
    if (ana->m_connectsucceeded[65]) m_againstElectronLooseMVA6 = &((*ana->againstElectronLooseMVA6)[idx]); else m_againstElectronLooseMVA6 = 0; 
    if (ana->m_connectsucceeded[66]) m_againstElectronMediumMVA6 = &((*ana->againstElectronMediumMVA6)[idx]); else m_againstElectronMediumMVA6 = 0; 
    if (ana->m_connectsucceeded[67]) m_againstElectronTightMVA6 = &((*ana->againstElectronTightMVA6)[idx]); else m_againstElectronTightMVA6 = 0; 
    if (ana->m_connectsucceeded[68]) m_againstElectronVTightMVA6 = &((*ana->againstElectronVTightMVA6)[idx]); else m_againstElectronVTightMVA6 = 0; 
    if (ana->m_connectsucceeded[69]) m_againstMuonLoose3 = &((*ana->againstMuonLoose3)[idx]); else m_againstMuonLoose3 = 0; 
    if (ana->m_connectsucceeded[70]) m_againstMuonTight3 = &((*ana->againstMuonTight3)[idx]); else m_againstMuonTight3 = 0; 
    if (ana->m_connectsucceeded[71]) m_byPhotonPtSumOutsideSignalCone = &((*ana->byPhotonPtSumOutsideSignalCone)[idx]); else m_byPhotonPtSumOutsideSignalCone = 0; 
    if (ana->m_connectsucceeded[72]) m_footprintCorrection = &((*ana->footprintCorrection)[idx]); else m_footprintCorrection = 0; 
