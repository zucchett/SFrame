...
//	Target = TFile::Open( "SingleMuonTrigger_2016.root", "RECREATE" );
//	vFileList.push_back(make_pair(TFile::Open("EfficienciesAndSF_RunBtoF.root"), (5.9+2.6+4.4+4.1+3.2)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
//	vFileList.push_back(make_pair(TFile::Open("EfficienciesAndSF_Period4.root"), (7.7+8.9)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
	
//	Target = TFile::Open( "MuonId_2016.root", "RECREATE" );
//	vFileList.push_back(make_pair(TFile::Open("IdEfficienciesAndSF_BCDEF.root"), (5.9+2.6+4.4+4.1+3.2)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
//	vFileList.push_back(make_pair(TFile::Open("IdEfficienciesAndSF_GH.root"), (7.7+8.9)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
//	
	Target = TFile::Open( "MuonIso_2016.root", "RECREATE" );
	vFileList.push_back(make_pair(TFile::Open("IsoEfficienciesAndSF_BCDEF.root"), (5.9+2.6+4.4+4.1+3.2)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
	vFileList.push_back(make_pair(TFile::Open("IsoEfficienciesAndSF_GH.root"), (7.7+8.9)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
	
//	Target = TFile::Open( "Ele27_passingTight_2016.root", "RECREATE" );
//	vFileList.push_back(make_pair(TFile::Open("Ele27_passingTight_RunBCDEFG_egammaEffi.txt_EGM2D.root"), (5.9+2.6+4.4+4.1+3.2+7.7)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
//	vFileList.push_back(make_pair(TFile::Open("Ele27_passingTight_RunHv23_egammaEffi.txt_EGM2D.root"), (8.9)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
	
//	Target = TFile::Open( "Ele32_passingTight_2016.root", "RECREATE" );
//	vFileList.push_back(make_pair(TFile::Open("Ele32_passingTight_RunBCDEFG_egammaEffi.txt_EGM2D.root"), (5.9+2.6+4.4+4.1+3.2+7.7)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
//	vFileList.push_back(make_pair(TFile::Open("Ele32_passingTight_RunHv23_egammaEffi.txt_EGM2D.root"), (8.9)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
	
//	Target = TFile::Open( "Ele115_passingTight_2016.root", "RECREATE" );
//	vFileList.push_back(make_pair(TFile::Open("Ele115_passingTight_RunBCDEFG_egammaEffi.txt_EGM2D.root"), (5.9+2.6+4.4+4.1+3.2+7.7)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
//	vFileList.push_back(make_pair(TFile::Open("Ele115_passingTight_RunHv23_egammaEffi.txt_EGM2D.root"), (8.9)/(5.9+2.6+4.4+4.1+3.2+7.7+8.9)));
...
//               h1->Add( h2 );
               h1->Add(h1, h2, first_weight, next_weight);
               delete h2;
            }
         }
